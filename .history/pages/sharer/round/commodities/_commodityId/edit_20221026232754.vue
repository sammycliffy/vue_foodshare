<template>
  <div class="scroll-overflow">
    <div class="half-width">
      ...
      <section v-if="!commodity" class="half-width py-5 text-center">
        Oops! Something Occured.
      </section>

      <section v-else class="body-primary">
        ...
        <div class="form-row">
          <div class="col">
            <div class="form-group">
              <label class="createFormLabel" for="productSlots"
        ...
        <div class="text-center mt-4">
          <b-btn class="btn primary-btn padded-btn" @click="saveCommodity"
            >Save
            <b-spinner
              v-if="spinner"
              variant="white"
  ...
  methods: {
    ...
    async saveCommodity() {
      if (this.validateFields()) {
        ...
        const URI = `/services/sharing-rounds/${this.sharingRoundPayload.sharerId}/${this.sharingRoundPayload.id}/commodities/${this.commodity.commodityName}`
        await this.$axios
