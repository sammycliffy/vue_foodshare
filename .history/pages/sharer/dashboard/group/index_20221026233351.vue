<template>
  <div class="scroll-overflow">
    <div class="half-width">
      <div class="d-flex justify-content-between mb-20">
        ...
        <div class="text-center">
          <div class="card-body d-flex align-center groupNumber">
            ...
            ></h5>
              ...
              v-else
              v-text="
                  `${Intl.NumberFormat().format(sharerDetails.members.length)}  Members`"
            ></h5> -->
          </div>
    ...
    <section v-else>
      <div
        v-if="groupMembers && groupMembers.length < 1"
        class="groupCard"
      >
        <div
          v-if="!displayInfo[i]"
      ...
      >
        ...
        <div class="col-9 pl-3">
          ...
          ></p>
            ...
            <span
              class="link text_semiBold"
              @click="toggleInfoDisplay(i)"
