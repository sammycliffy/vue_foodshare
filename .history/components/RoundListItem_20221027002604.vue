        ...
        <div class="d-flex justify-content-between">
          <span>
            ...
            <span class="ml-1 mini-title">
              <span>{{ item.commoditiesDetails.length }} {{ item.commoditiesDetails.length > 1 ? 'Products' : 'Product' }}
              </span>
            </span>
          </span>
          <span>
        ...
        >
          ...
          <span>
            ...
            <span class="fs-12 text_semiBold">
              &#8358; {{ Intl.NumberFormat().format( item.sharingRoundFinancials.totalTransaction ) }}
            </span>
          </span>
          </div>
          <div
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      <p
                        class="mb-16 text_medium"
                        v-text="sharingRoundToCopy.name"
                      ></p>
                ...
                new Date(sharingRoundToCopy.cutOffTime).toLocaleString()
                                ...
                                {{ sharingRoundToCopy.cutOffTimeWithDay }} {{ new Date(sharingRoundToCopy.startTime).toLocaleTimeString() }}
                              </span>
                            </p>
                          </div>
                ...
                new Date(sharingRoundToCopy.endTime).toLocaleString()
                                ...
                                {{ sharingRoundToCopy.endTimeWithDay }} {{ new Date(sharingRoundToCopy.endTime).toLocaleTimeString() }}
                              </span>
                            </p>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          <div class="col-4 align-self-center">
                            <p class="mb-0">
                              <span>&#8358; {{ Intl.NumberFormat().format(product.sharingPrice) }}</span>
                            </p>
                          </div>
...
export default {
  ...
  methods: {
    ...
    reCreateRound(item) {
      ...
      this.reCreateData.name = item.name + new Date().getTime()
    ...
    copyRoundStatus(item) {
      ...
      // sharingRoundStatus += `Order startTime:\n${new Date(
      //   item.startTime
      // ).toLocaleTimeString()}\n\n`

      sharingRoundStatus += `Sharing day:\n${item.endTimeWithDay}\n${new Date(
        ).toLocaleTimeString()}\n\n `
      // sharingRoundStatus += `Sharing time:\n${new Date(
      //   item.endTime
      // ).toLocaleTimeString()}\n\n`
